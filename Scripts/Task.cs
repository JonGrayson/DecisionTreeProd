...
public class BargeDoor : Task
{
    ...
    public override void run()
    {
        mDoor.AddForce(-100f, 0, 0, ForceMode.VelocityChange);
        succeeded = true;
        EventBus.TriggerEvent(TaskFinished);
    }
}
...
//Task 1/3 made
public class returnToNormal : Task
{
    GameObject mEntity;

    public returnToNormal(GameObject someEntity)
    {
        mEntity = someEntity;
    }
...
//Task 2/3
public class Particles : Task
{
    ParticleSystem mParticles;

    public Particles(ParticleSystem someParticles)
    {
        mParticles = someParticles;
    }
...
//Task 3/3
public class HideOpenDoor : Task
{
    GameObject mEntity;

    public HideOpenDoor(GameObject someEntity)
    {
        mEntity = someEntity;
    }
